    ...
    <View style={{ flex: 1 }}>
      <View>
        ...
        {state.filters.map((x, index) => {
          return <View key={index}>{render_filter(x, dispatch)}</View>;
        })}
      </View>
      <FlatList
        ...
        if (value !== undefined) {
          return (
            <>
              ...
              <Pressable
                onPress={() =>
                  dispatch(["filters", 0, "id", [true, undefined]])
                }
              >
                <Text>X</Text>
              </Pressable>
          ...
          return (
            <>
              <Switch
                value={active}
                onValueChange={(x) => {
                  dispatch(["filters", 0, "created_at", [x, value]]);
                }}
              />
              ...
              <Pressable
                onPress={() =>
                  dispatch(["filters", 0, "created_at", [true, undefined]])
                }
              >
                <Text>X</Text>
              </Pressable>
